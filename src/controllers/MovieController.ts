...
class MovieController {
  ...
  public getGenresList = async (_req: Request, res: Response) => {
    try {
      ...
      this.ApiResponse.successResponse(
        res,
        data,
        "Successfully fetched genres list!"
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public getMovieByCountry = async (req: Request, res: Response) => {
    const country = decodeURIComponent(
      (req.params as { country: string }).country
    );
    const page = (req.query as unknown as { page: number }).page;

    try {
      const data = await this.flixhq.fetchMovieByGenreOrCountry(
        Filter.COUNTRY,
        country,
        page
      );
      this.ApiResponse.successResponse(
        res,
        data,
        `Successfully fetched movies by country ${country}!`
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public getMovieByGenre = async (req: Request, res: Response) => {
    ...
    try {
      ...
      this.ApiResponse.successResponse(
        res,
        data,
        `Successfully fetched movies by genre ${genre}!`
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public getMovies = async (req: Request, res: Response) => {
    ...
    try {
      ...
      this.ApiResponse.successResponse(
        res,
        data,
        "Successfully fetched movies list!"
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public getTvShows = async (req: Request, res: Response) => {
    ...
    try {
      ...
      this.ApiResponse.successResponse(
        res,
        data,
        "Successfully fetched TVShows list!"
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public getMovieByTopIMDB = async (req: Request, res: Response) => {
    ...
    try {
      ...
      this.ApiResponse.successResponse(
        res,
        data,
        "Successfully fetched movies by top IMDB!"
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public getMovieInfo = async (req: Request, res: Response) => {
    ...
    try {
      ...
      this.ApiResponse.successResponse(
        res,
        data,
        "Successfully fetched movie/tv-show info!"
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public getEpisodeServers = async (req: Request, res: Response) => {
    ...
    try {
      ...
      this.ApiResponse.successResponse(
        res,
        data,
        "Successfully fetched episode servers!"
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public getEpisodeSources = async (req: Request, res: Response) => {
    ...
    try {
      const data = await this.flixhq.fetchEpisodeSources(
        mediaId,
        episodeId,
        server
      );
      this.ApiResponse.successResponse(
        res,
        data,
        "Successfully fetched streaming sources!"
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public getFiltersList = async (req: Request, res: Response) => {
    try {
      ...
      this.ApiResponse.successResponse(
        res,
        data,
        "Successfully fetched filters list!"
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public filter = async (req: Request, res: Response) => {
    ...
    try {
      const data = await this.flixhq.filter(
        { type, quality, released, genre, country },
        page
      );
      this.ApiResponse.successResponse(
        res,
        data,
        "Successfully fetched movies/tv-shows!"
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
  ...
  public search = async (req: Request, res: Response) => {
    ...
    try {
      ...
      this.ApiResponse.successResponse(
        res,
        data,
        `Successfully fetched movies/tv-shows has name is ${query}!`
      );
    } catch (err) {
      this.ApiResponse.serverErrorResponse(res);
    }
